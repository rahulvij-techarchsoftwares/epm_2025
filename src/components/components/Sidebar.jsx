...
export function Sidebar() {
  ...
  const menuItems = {
    ...
    [Roles.PM]: [
      { name: "Dashboard", path: "/projectmanager/dashboard" },
    ...
    [Roles.TEAM]: [
      ...
      { name: "Projects Assigned", path: "/team/projects-assigned" },
      { name: "Performance Sheet", path: "/team/performance-sheet" },
      { name: "Performance History", path: "/team/performance-sheet-History" },
      { name: "Leaves", path: "/team/leaves" },
    ],
  };
